...
class Multi :
    ...
    def draw_players_1(self, cords_player_1: Couple):
        efface("player_1")
        rectangle(cords_player_1.x, cords_player_1.y, cords_player_1.x + 25, cords_player_1.y + 25, couleur='red', remplissage='red', tag='player_1')

    def draw_players_2(self, cords_player_2: Couple):
        efface("player_2")
        rectangle(cords_player_2.x, cords_player_2.y, cords_player_2.x + 25, cords_player_2.y + 25, couleur='blue', remplissage='blue', tag='player_2')
